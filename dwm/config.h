...
static const char *fonts[]          = { "IPAGothic:size=12",
					"UnBatang:size=12"
};
static const char dmenufont[]       = " IPAGothic:size=12";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_e,      spawn,          SHCMD("emacsclient -a '' -c") },
	{ MODKEY,                       XK_r,      spawn,          {.v = webcmd } },
	//{ MODKEY|ShiftMask,             XK_r,      spawn,          SHCMD("tabbed -r2 -c surf -e x search.brave.com & disown") },
	//{ MODKEY|ShiftMask,             XK_o,      spawn,          SHCMD("tabbed -r2 -c surf -e x search.brave.com & disown") },
	//{ MODKEY,                       XK_o,      spawn,          {.v = webcmd } },
	{ MODKEY,                       XK_u,      spawn,          SHCMD("st ranger") },
	{ MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("st mocp") },
